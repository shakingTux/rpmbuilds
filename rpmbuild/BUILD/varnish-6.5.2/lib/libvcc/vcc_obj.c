...
vcc_Var_Init(struct vcc *tl)
{
	...
	sym = VCC_MkSym(tl, "local.ip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = IP;
	...
	sym = VCC_MkSym(tl, "local.endpoint", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "local.socket", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "remote.ip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = IP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "client.ip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = IP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "client.identity", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "server.ip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = IP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "server.hostname", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "server.identity", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = HTTP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.method", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.hash", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BLOB;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.url", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.proto", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.proto", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_req_proto(ctx)";
	...
	sym = VCC_MkSym(tl, "req.http", SYM_MAIN, SYM_NONE, 0, 99);
	AN(sym);
	...
	sym->w_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
	sym->uname = "VRT_u_req_http(ctx)";
	sym->u_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;

	sym = VCC_MkSym(tl, "req.restarts", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.storage", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STEVEDORE;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.esi_level", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.ttl", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.grace", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.xid", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.esi", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.can_gzip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.backend_hint", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BACKEND;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.hash_ignore_busy", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.hash_always_miss", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.is_hitmiss", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req.is_hitpass", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req_top.method", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req_top.url", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "req_top.http", SYM_MAIN, SYM_NONE, 0, 99);
	AN(sym);
	sym->wildcard = vcc_Var_Wildcard;
	AN(sym);
	sym->type = HEADER;
	...
	sym = VCC_MkSym(tl, "req_top.proto", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = HTTP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.xid", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.retries", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.backend", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BACKEND;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.body", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BODY;
	sym->eval = vcc_Eval_Var;
	sym->r_methods =
	...
	sym = VCC_MkSym(tl, "bereq.hash", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BLOB;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.method", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.url", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.proto", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.proto", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_bereq_proto(ctx)";
	...
	sym = VCC_MkSym(tl, "bereq.http", SYM_MAIN, SYM_NONE, 0, 99);
	AN(sym);
	sym->wildcard = vcc_Var_Wildcard;
	AN(sym);
	sym->type = HEADER;
	...
	sym->w_methods =
		VCL_MET_BACKEND_ERROR | VCL_MET_BACKEND_FETCH
		 | VCL_MET_BACKEND_RESPONSE | VCL_MET_PIPE;
	sym->uname = "VRT_u_bereq_http(ctx)";
	sym->u_methods =
		VCL_MET_BACKEND_ERROR | VCL_MET_BACKEND_FETCH
		 | VCL_MET_BACKEND_RESPONSE | VCL_MET_PIPE;

	sym = VCC_MkSym(tl, "bereq.uncacheable", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.connect_timeout", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.first_byte_timeout", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.between_bytes_timeout", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "bereq.is_bgfetch", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = HTTP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.body", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BODY;
	sym->eval = vcc_Eval_Var;
	sym->r_methods =
	...
	sym = VCC_MkSym(tl, "beresp.proto", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.proto", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_beresp_proto(ctx)";
	...
	sym = VCC_MkSym(tl, "beresp.status", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.reason", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.http", SYM_MAIN, SYM_NONE, 0, 99);
	AN(sym);
	sym->wildcard = vcc_Var_Wildcard;
	AN(sym);
	sym->type = HEADER;
	...
	sym->w_methods =
		VCL_MET_BACKEND_ERROR | VCL_MET_BACKEND_RESPONSE;
	sym->uname = "VRT_u_beresp_http(ctx)";
	sym->u_methods =
		VCL_MET_BACKEND_ERROR | VCL_MET_BACKEND_RESPONSE;

	sym = VCC_MkSym(tl, "beresp.do_esi", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.do_stream", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.do_gzip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.do_gunzip", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.was_304", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.uncacheable", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.ttl", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.age", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.grace", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.keep", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.backend", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BACKEND;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.backend.name", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.backend.ip", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = IP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.storage", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STEVEDORE;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.storage_hint", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "beresp.filters", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_beresp_filters(ctx)";
	sym->r_methods =
		VCL_MET_BACKEND_RESPONSE;
	sym->lname = "VRT_l_beresp_filters(ctx, ";
	sym->w_methods =
		VCL_MET_BACKEND_RESPONSE;
	sym->u_methods =
		0;

	sym = VCC_MkSym(tl, "obj.proto", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.status", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.reason", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.hits", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.http", SYM_MAIN, SYM_NONE, 0, 99);
	AN(sym);
	sym->wildcard = vcc_Var_Wildcard;
	AN(sym);
	sym->type = HEADER;
	...
	sym = VCC_MkSym(tl, "obj.ttl", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.age", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.grace", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.keep", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.uncacheable", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.storage", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STEVEDORE;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "obj.can_esi", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_obj_can_esi(ctx)";
	sym->r_methods =
		VCL_MET_DELIVER | VCL_MET_HIT;
	sym->w_methods =
		0;
	...
	sym = VCC_MkSym(tl, "resp", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = HTTP;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "resp.body", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BODY;
	sym->eval = vcc_Eval_Var;
	sym->r_methods =
	...
	sym = VCC_MkSym(tl, "resp.proto", SYM_MAIN, SYM_VAR, 0, 40);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "resp.proto", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_resp_proto(ctx)";
	...
	sym = VCC_MkSym(tl, "resp.status", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = INT;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "resp.reason", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "resp.http", SYM_MAIN, SYM_NONE, 0, 99);
	AN(sym);
	sym->wildcard = vcc_Var_Wildcard;
	AN(sym);
	sym->type = HEADER;
	...
	sym->w_methods =
		VCL_MET_DELIVER | VCL_MET_SYNTH;
	sym->uname = "VRT_u_resp_http(ctx)";
	sym->u_methods =
		VCL_MET_DELIVER | VCL_MET_SYNTH;

	sym = VCC_MkSym(tl, "resp.do_esi", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "resp.is_streaming", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = BOOL;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "resp.filters", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_resp_filters(ctx)";
	sym->r_methods =
		VCL_MET_DELIVER | VCL_MET_SYNTH;
	sym->lname = "VRT_l_resp_filters(ctx, ";
	sym->w_methods =
		VCL_MET_DELIVER | VCL_MET_SYNTH;
	sym->u_methods =
		0;

	sym = VCC_MkSym(tl, "now", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = TIME;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "sess.xid", SYM_MAIN, SYM_VAR, 41, 99);
	AN(sym);
	sym->type = STRING;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "sess.timeout_idle", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	...
	sym = VCC_MkSym(tl, "sess.timeout_linger", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_sess_timeout_linger(ctx)";
	sym->r_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
	sym->lname = "VRT_l_sess_timeout_linger(ctx, ";
	sym->w_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
	...
	sym = VCC_MkSym(tl, "sess.send_timeout", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_sess_send_timeout(ctx)";
	sym->r_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
	sym->lname = "VRT_l_sess_send_timeout(ctx, ";
	sym->w_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
	...
	sym = VCC_MkSym(tl, "sess.idle_send_timeout", SYM_MAIN, SYM_VAR, 0, 99);
	AN(sym);
	sym->type = DURATION;
	sym->eval = vcc_Eval_Var;
	sym->rname = "VRT_r_sess_idle_send_timeout(ctx)";
	sym->r_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
	sym->lname = "VRT_l_sess_idle_send_timeout(ctx, ";
	sym->w_methods =
		VCL_MET_DELIVER | VCL_MET_HASH | VCL_MET_HIT | VCL_MET_MISS
		 | VCL_MET_PASS | VCL_MET_PIPE | VCL_MET_PURGE
		 | VCL_MET_RECV | VCL_MET_SYNTH;
